    ...
    <div class="container pt-12 pt-lg-6 pb-13 pb-md-15">
      ...
      <div class="row gy-6 gy-lg-0">
        <div class="col-md-4 col-lg-3">
          <div class="widget">
            <!-- Dùng /assets/... (trong public/) -->
            <img class="mb-4" src="/assets/img/logo-light.png" srcset="/assets/img/logo-light@2x.png 2x" alt="Logo" />
            <p class="mb-4">
              © {{ currentYear }} Sandbox. <br class="d-none d-lg-block" />All rights reserved.
            </p>
          ...
          <div class="widget">
            ...
            <div class="newsletter-wrapper">
              <div id="mc_embed_signup2">
                <!-- Sửa novalidate="" -> novalidate (hoặc :novalidate="true") -->
                <form
