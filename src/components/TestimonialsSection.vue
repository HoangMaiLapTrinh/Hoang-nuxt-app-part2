...
<section class="wrapper bg-gradient-primary">
      <div class="container pt-12 pt-lg-8 pb-14 pb-md-17">
        ...
        <!-- /.row -->
        <div class="grid">
          <div class="row isotope gy-6" style="position: relative; height: 928.688px;">
            ...
            <!--/column -->
            <div class="item col-md-6 col-xl-4" style="position: absolute; left: 0%; top: 418.453px;">
              <div class="card shadow-lg">
                <div class="card-body">
                  <span class="ratings five mb-2"></span>
                  <blockquote class="border-0 mb-0">
            ...
            <!--/column -->
            <div class="item col-md-6 col-xl-4" style="position: absolute; left: 66.6667%; top: 479.641px;">
              <div class="card shadow-lg">
                <div class="card-body">
                  <span class="ratings five mb-2"></span>
                  <blockquote class="border-0 mb-0">
            ...
            <!--/column -->
            <div class="item col-md-6 col-xl-4" style="position: absolute; left: 33.3333%; top: 510.234px;">
              <div class="card shadow-lg">
                <div class="card-body">
                  <span class="ratings five mb-2"></span>
                  <blockquote class="border-0 mb-0">
